            ...
            <div class="service-card">
                ...
                <div class="service-body">
                    ...
                    <div class="photographer-info">
                        <img src="${
                          service.photographer.profile_image ||
                          "../assets/images/default-avatar.jpg"
                        }" alt="${
      service.photographer.name
                        ...
                        <div class="photographer-details">
                            ...
                            <div class="photographer-rating">
                                <i class="bi bi-star-fill"></i> ${
                                  service.photographer.rating || "5.0"
                                }
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="service-meta">
                        <div class="service-price">
                            <i class="bi bi-tag"></i> ${
                              service.price_range || "Price varies"
                            }
                        </div>
  ...
  let html = `
    ...
    service.photographer.name
                        ...
                        <div class="photographer-detail-info">
                            <h5 class="photographer-detail-name">${
                              service.photographer.name
                            }</h5>
                            <p class="photographer-detail-location"><i class="bi bi-geo-alt"></i> ${
                    ...
                    <p class="photographer-detail-bio">${
                      service.photographer.bio_excerpt ||
                      "Professional photographer on LensLink."
                    }</p>
                    <a href="./photographer-detail.html?id=${
